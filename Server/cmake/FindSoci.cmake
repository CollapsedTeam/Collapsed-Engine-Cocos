...
IF(SOCI_INCLUDE_DIR AND SOCI_LIBRARY)
    ...
    MESSAGE(STATUS "*CE* Soci found: Looking for plugins")
    FOREACH(plugin IN LISTS _SOCI_ALL_PLUGINS)
        ...
        IF(SOCI_${plugin}_PLUGIN)
            MESSAGE(STATUS "*CE* Plugin ${plugin} found ${SOCI_${plugin}_LIBRARY}")
            SET(SOCI_FOUND True)
        ELSE()
            MESSAGE(STATUS "*CE* Plugin ${plugin} not found.")
